...
$(document).ready(function() {
    ...
    $(".calendar .btnCal").click(function(e){
        $(this).siblings("input").datepicker("show");
    });
    
    $(".searchA button.month1").click(function(e){
        $(this).parent().find(".calendar:eq(0) > input").datepicker('setDate', '-1m');
        $(this).parent().find(".calendar:eq(1) > input").datepicker('setDate', new Date());
    });
    
    $(".searchA button.month3").click(function(e){
        $(this).parent().find(".calendar:eq(0) > input").datepicker('setDate', '-3m');
        $(this).parent().find(".calendar:eq(1) > input").datepicker('setDate', new Date());
    });
    
    $(".searchA button.month6").click(function(e){
        $(this).parent().find(".calendar:eq(0) > input").datepicker('setDate', '-6m');
        $(this).parent().find(".calendar:eq(1) > input").datepicker('setDate', new Date());
    });
    
    $(".searchA button.month12").click(function(e){
        $(this).parent().find(".calendar:eq(0) > input").datepicker('setDate', '-12m');
        $(this).parent().find(".calendar:eq(1) > input").datepicker('setDate', new Date());
    });
    
    //reset date
    $(".searchTbl button.i_btn").click(function(e){
        $(this).parent().parent().parent().find(".calendar:eq(0) > input").datepicker('setDate', null);
        $(this).parent().parent().parent().find(".calendar:eq(1) > input").datepicker('setDate', null);
        $(this).parent().parent().parent().find(".searchA > input").val("");
    });
    ...
    $(".board thead > tr > th > a").click(function(e){
        var imgUrl = $(this).find("img").attr("src");
        if(imgUrl.indexOf("down") > -1){
            $(this).find("img").attr("src","images/admin/btn_arrow_up.gif");    
        }else{
            $(this).find("img").attr("src","images/admin/btn_arrow_down.gif");    
        }
    });
});
...
function popupClickEvent(){
    $("a.pop_a").off().on("click",function(e){
        e.stopPropagation();
        e.preventDefault();     
        var popupMarginTop = 82;
        var headerHeight = $("#header").outerHeight();
        var h1 = $(window).height();
        var h2 = $(".popup_area").height();
        var poptop =  h1/2 - h2/2 - popupMarginTop/2 +headerHeight/2;
        if( poptop < 0 ) {
            poptop= 0;
        }
        
        $(".popup_area").css( {position:"fixed", top:poptop,"z-index":991} );  
        $(".dimmed").css("z-index",990);
        $(".popup_area").show();
        $(".dimmed").show();
        $(window).resize(inputPopupResize);
    });
    
    function inputPopupResize(){
        $(window).off("resize", inputPopupResize);
        $(".popup_area").hide();
        $(".dimmed").hide();
    }
    
    $(".dimmed").off().on("click",function(e){
        e.stopPropagation();
        e.preventDefault();
        $(".popup_area a.closeBtn").trigger("click");
    });
        
    $(".popup_area a.closeBtn").on("click",function(e){
        e.stopPropagation();
        e.preventDefault();           
        $(".popup_area").hide();
        $(".dimmed").hide();
